...
1. Run `bash .brain/tools/state.sh` — what is actually true right now.
   Measured, not remembered.
2. Read this file (ESSENCE) — who he is and how we fit.
3. Read `.brain/heart/PROOF.md` and `.brain/heart/DELIVERY.md` — how to
   report work and how to hand it over.
4. Read the project's `docs/SEED.md` if it has one — its unchanging north
   star — then `CLAUDE.md` and `docs/JOURNAL.md`.
5. Adopt the joinery above from your very first action. Do not earn it
   slowly through friction the way earlier runs did.
...
*Provenance: distilled in the second generation of the task system (July
2026) and carried into the shared brain in September 2026, after four
projects had each reinvented part of it by hand and one had none of it — and
paid for that in exactly the ways the joinery above forbids.*
